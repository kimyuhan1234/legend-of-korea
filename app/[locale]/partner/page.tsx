...
const META: Record<string, { title: string; desc: string }> = {
  ko: { title: '제휴 문의 | Clouds with you', desc: '비즈니스 제휴 및 협력 문의' },
  en: { title: 'Partnership | Clouds with you', desc: 'Business partnership inquiries' },
  ja: { title: '提携お問い合わせ | Clouds with you', desc: 'ビジネス提携のお問い合わせ' },
}

const CONTENT: Record<string, { title: string; body: string; email: string }> = {
  ko: { title: '제휴 문의', body: 'Clouds with you와의 비즈니스 제휴를 원하시면 아래 이메일로 문의해 주세요.', email: '문의: hello@legendofkorea.kr' },
  en: { title: 'Partnership', body: 'Interested in a business partnership with Clouds with you? Contact us at the email below.', email: 'Contact: hello@legendofkorea.kr' },
  ja: { title: '提携お問い合わせ', body: 'Clouds with youとのビジネス提携をご希望の方は、以下のメールアドレスまでお問い合わせください。', email: 'お問い合わせ: hello@legendofkorea.kr' },
}
