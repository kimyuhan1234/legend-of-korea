...
const CONTENT: Record<string, { title: string; subtitle: string; items: QA[] }> = {
  ko: {
    ...
    items: [
      { q: '미션 키트는 어떻게 받나요?', a: '여행 패스 구매 후 입력한 숙소 주소로 무료 배송됩니다. 체크인 전날까지 도착하도록 발송해 드립니다.' },
      ...
      { q: '취소 및 환불은 어떻게 되나요?', a: '키트 발송 전까지 100% 환불 가능합니다. 발송 후 미개봉 상태로 반품 시 환불 처리됩니다. 자세한 내용은 고객센터로 문의해 주세요.' },
  ...
  en: {
    ...
    items: [
      { q: 'How do I receive the mission kit?', a: 'After purchasing a travel pass, the kit is shipped free of charge to the address you provide. We dispatch it to arrive before your check-in date.' },
      ...
      { q: 'How does cancellation and refund work?', a: 'Full refund is available before the kit is shipped. After shipment, returns of unopened kits are eligible for refund. Contact customer support for details.' },
  ...
  ja: {
    ...
    items: [
      { q: 'ミッションキットはどう受け取りますか?', a: '旅行パス購入後、ご入力いただいた宿泊先の住所へ無料配送されます。チェックイン前日までに届くよう発送いたします。' },
      ...
      { q: 'キャンセル・返金はどのようになりますか?', a: 'キット発送前は100%返金可能です。発送後は未開封品のみ返金対象となります。詳細はカスタマーサポートまでお問い合わせください。' },
  ...
  'zh-CN': {
    ...
    items: [
      { q: '任务套件如何收到?', a: '购买旅行通行证后，将免费配送至您填写的住宿地址。我们会确保在入住前一天送达。' },
      { q: '一个人也能玩吗?', a: '当然可以。我们提供单人套件和双人套件，独自旅行者也能尽情体验。' },
      { q: '是否支持韩语以外的其他语言?', a: '支持。韩语 / 日语 / 英语 / 简体中文 / 繁体中文 共五种语言。' },
      { q: '如何取消和退款?', a: '套件发货前可全额退款。发货后未开封状态可退货退款。详情请联系客服。' },
  ...
  'zh-TW': {
    ...
    items: [
      { q: '任務套件如何收到?', a: '購買旅行通行證後，將免費配送至您填寫的住宿地址。我們會確保在入住前一天送達。' },
      { q: '一個人也能玩嗎?', a: '當然可以。我們提供單人套件和雙人套件，獨自旅行者也能盡情體驗。' },
      { q: '是否支援韓語以外的其他語言?', a: '支援。韓語 / 日語 / 英語 / 簡體中文 / 繁體中文 共五種語言。' },
      { q: '如何取消和退款?', a: '套件發貨前可全額退款。發貨後未開封狀態可退貨退款。詳情請聯絡客服。' },
