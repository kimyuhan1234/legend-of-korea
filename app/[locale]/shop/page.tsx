...
import { Loader2, Ticket, ChevronRight, Coins, History, Calendar, Trophy, ArrowUpRight, ArrowDownLeft, CheckCircle2, Sparkles } from 'lucide-react';
  ...
  const fetchShopData = async () => {
    try {
      ...
      const [userRes, couponsRes] = await Promise.all([
        fetch('/api/auth/me'), // Assuming this endpoint exists to get current user data
        fetch('/api/shop/coupons') // Need to create this or use a general endpoint
      ]);
