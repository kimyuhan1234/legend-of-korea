  ...
  return (
    <div className="min-h-screen bg-snow">
      ...
      <div className="bg-gradient-to-br from-mint-light via-peach to-blossom border-b border-mist py-20 md:py-28 px-6 md:px-10 text-center">
        <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-white text-mint-deep text-xs font-bold uppercase tracking-widest mb-5 shadow-sm">
          <Leaf className="w-3.5 h-3.5" strokeWidth={2} aria-hidden />
          {h.badge}
        </span>
