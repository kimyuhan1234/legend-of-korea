...
const TEXT: Record<Lang, {
  ...
  // 마케팅팀 채택안 + 디자인팀 구조 결합
  ko: {
    title: '14세 미만 안내 | Cloud with you',
    headline: '더 자라서 만나요!',
    body: 'Cloud with you는 만 14세부터 함께할 수 있어요. 한국의 전설을 함께 탐험할 날을 기다릴게요.',
    parentLabel: '부모님과 함께 가입하고 싶으세요?',
    parentSubject: '[Cloud with you] 부모 동반 가입 문의',
    cta: '홈으로 돌아가기',
  },
  ja: {
    title: '14歳未満のご案内 | Cloud with you',
    headline: 'もう少し大きくなったら会おうね',
    body: 'Cloud with youは14歳から一緒に旅できます。韓国の伝説を一緒に探検する日を待っています。',
    parentLabel: '保護者の方と一緒に登録しますか？',
    parentSubject: '[Cloud with you] 保護者同伴での登録について',
    cta: 'ホームに戻る',
  },
  en: {
    title: 'Age Restriction | Cloud with you',
    headline: "Let's meet again when you're a little older",
    body: "Cloud with you is for travelers age 14 and up. We'll be here to explore Korean legends with you.",
    parentLabel: 'Want to sign up with a parent?',
    parentSubject: '[Cloud with you] Sign-up with a parent',
    cta: 'Back to home',
  },
  'zh-CN': {
    title: '年龄限制 | Cloud with you',
    headline: '等你再长大一点，我们再见面吧',
    body: 'Cloud with you 是为14岁及以上的旅行者准备的。期待和你一起探索韩国传说的那天。',
    parentLabel: '想和家长一起注册吗？',
    parentSubject: '[Cloud with you] 与家长共同注册咨询',
    cta: '返回首页',
  },
  'zh-TW': {
    title: '年齡限制 | Cloud with you',
    headline: '等你再長大一點，我們再見面吧',
    body: 'Cloud with you 是為14歲以上的旅行者準備的。期待和你一起探索韓國傳說的那天。',
    parentLabel: '想和家長一起註冊嗎？',
    parentSubject: '[Cloud with you] 與家長共同註冊諮詢',
    cta: '返回首頁',
  },
}
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
      <div className="max-w-md w-full text-center bg-white rounded-3xl border border-mist shadow-lg shadow-slate-200/50 p-10">
        ...
        {/* 부모 가입 안내 */}
        <div className="border-t border-mist pt-6 mb-6">
          <p className="text-xs text-stone mb-2">{t.parentLabel}</p>
          <a
            href={`mailto:${PARENT_EMAIL}?subject=${encodeURIComponent(t.parentSubject)}`}
            className="text-sm text-blossom-deep underline hover:text-blossom-deep/80"
          >
            {PARENT_EMAIL}
          </a>
        </div>
