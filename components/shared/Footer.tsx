    ...
    <footer className="bg-[#1B2A4A] text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-lg bg-[#D4A843] flex items-center justify-center">
                <span className="text-[#1B2A4A] font-black text-sm">伝</span>
              </div>
          ...
          {/* 네비게이션 */}
          <div>
            <h3 className="font-semibold text-sm text-white/70 mb-3 uppercase tracking-wider">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${locale}/terms`} className="text-sm text-white/60 hover:text-[#D4A843] transition-colors">
                  {t.terms}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/privacy`} className="text-sm text-white/60 hover:text-[#D4A843] transition-colors">
                  {t.privacy}
                </Link>
              </li>
              <li>
                <a href="mailto:hello@legendofkorea.kr" className="text-sm text-white/60 hover:text-[#D4A843] transition-colors">
                  {t.contact}
                </a>
              </li>
            </ul>
            ...
            {["ko", "ja", "en"].map((lang) => (
              <Link
                ...
                className={`text-xs transition-colors ${
                  locale === lang ? "text-[#D4A843]" : "text-white/40 hover:text-white/70"
                }`}
              >
