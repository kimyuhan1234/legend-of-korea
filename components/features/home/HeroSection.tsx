  ...
  return (
    <section className="relative h-screen overflow-hidden bg-[#2D1B69]">
      ...
      <button
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/70 hover:text-white transition-colors animate-bounce"
        aria-label={cta}
      >
