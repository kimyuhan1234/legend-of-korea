...
export function GoodsCard({ product, locale }: GoodsCardProps) {
  ...
  return (
    <div className="group bg-white rounded-3xl overflow-hidden border border-[#e8ddd0]/40 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
      {/* 이모지 히어로 */}
      <div className="relative h-40 bg-gradient-to-br from-[#FF6B35]/10 to-[#FF6B35]/30 flex items-center justify-center">
