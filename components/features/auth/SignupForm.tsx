...
const TEXT: Record<Lang, {
  ...
  ko: {
    ...
    successDesc: "Clouds with you에 오신 것을 환영합니다!",
  ...
  ja: {
    ...
    successTitle: "🎉 新規登録完了！",
    successDesc: "Clouds with you へようこそ！",
  ...
  en: {
    ...
    successDesc: "Welcome to Clouds with you!",
  ...
  'zh-CN': {
    ...
    passwordMatch: "密码一致",
    successTitle: "🎉 注册成功！",
    successDesc: "欢迎来到 Clouds with you！",
  ...
  'zh-TW': {
    ...
    passwordMatch: "密碼一致",
    successTitle: "🎉 註冊成功！",
    successDesc: "歡迎來到 Clouds with you！",
